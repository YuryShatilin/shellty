...
public class ShelltyParser extends Parser {
	...
	public static final int
		...
		RULE_typeSpecifier = 27, RULE_structDeclarationList = 28, RULE_structDeclaration = 29, 
		RULE_specifierQualifierList = 30, RULE_structSpecifier = 31, RULE_structDeclaratorList = 32, 
		RULE_structDeclarator = 33, RULE_enumSpecifier = 34, RULE_enumeratorList = 35, 
		RULE_enumerator = 36, RULE_enumerationConstant = 37, RULE_typeQualifier = 38, 
		RULE_declarator = 39, RULE_directDeclarator = 40, RULE_bashExtension = 41, 
		RULE_typeQualifierList = 42, RULE_parameterTypeList = 43, RULE_parameterList = 44, 
		...
		RULE_initializerList = 51, RULE_designation = 52, RULE_designator = 53, 
	...
	public static final String[] ruleNames = {
		...
		"initDeclaratorList", "initDeclarator", "typeSpecifier", "structDeclarationList", 
		"structDeclaration", "specifierQualifierList", "structSpecifier", "structDeclaratorList", 
			...
			case StringLiteral:
				...
				do {
					...
					case 1:
						{
						{
						setState(138); match(StringLiteral);
						}
						}
						break;
					default:
	...
	private PostfixExpressionContext postfixExpression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(150); primaryExpression();
				}
				break;
			...
			case 2:
				...
				setState(152); typeName();
				setState(153); match(RightParen);
				setState(154); match(LeftBrace);
				setState(155); initializerList(0);
				setState(156); match(RightBrace);
				}
				break;
			...
			case 3:
				...
				setState(159); typeName();
				setState(160); match(RightParen);
				setState(161); match(LeftBrace);
				setState(162); initializerList(0);
				setState(163); match(Comma);
				setState(164); match(RightBrace);
				}
				break;
			}
	...
	private ArgumentExpressionListContext argumentExpressionList(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(192); assignmentExpression();
			}
			_ctx.stop = _input.LT(-1);
			setState(199);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					setState(196); assignmentExpression();
					}
					} 
				}
				setState(201);
	...
	public final UnaryExpressionContext unaryExpression() throws RecognitionException {
		...
		try {
			...
			case StringLiteral:
				enterOuterAlt(_localctx, 1);
				{
				setState(202); postfixExpression(0);
				}
				break;
			case PlusPlus:
				enterOuterAlt(_localctx, 2);
				{
				setState(203); match(PlusPlus);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(225);
						if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
						setState(226); match(Star);
						setState(227); castExpression();
						}
						break;
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(244); multiplicativeExpression(0);
						}
						break;
					...
					case 2:
						...
						setState(247); multiplicativeExpression(0);
						}
						break;
					}
					} 
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(256);
						if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
						setState(257); match(LeftShift);
						setState(258); additiveExpression(0);
						}
						break;
					...
					case 2:
						...
						setState(259);
						if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
						setState(260); match(RightShift);
						setState(261); additiveExpression(0);
						}
						break;
					}
					} 
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 2:
						...
						setState(273);
						if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
						setState(274); match(Greater);
						setState(275); shiftExpression(0);
						}
						break;
					...
					case 3:
						...
						setState(276);
						if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
						setState(277); match(LessEqual);
						setState(278); shiftExpression(0);
						}
						break;
					...
					case 4:
						...
						setState(279);
						if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
						setState(280); match(GreaterEqual);
						setState(281); shiftExpression(0);
						}
						break;
					}
					} 
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(290);
						if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
						setState(291); match(Equal);
						setState(292); relationalExpression(0);
						}
						break;
					...
					case 2:
						...
						setState(293);
						if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
						setState(294); match(NotEqual);
						setState(295); relationalExpression(0);
						}
						break;
					}
					} 
	...
	private AndExpressionContext andExpression(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(302); equalityExpression(0);
			}
			_ctx.stop = _input.LT(-1);
			setState(309);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					setState(306); equalityExpression(0);
					}
					} 
				}
				setState(311);
		...
		try {
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					setState(315);
					if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
					setState(316); match(Caret);
					setState(317); andExpression(0);
					}
					} 
				}
				setState(322);
	...
	private InclusiveOrExpressionContext inclusiveOrExpression(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(324); exclusiveOrExpression(0);
			}
			_ctx.stop = _input.LT(-1);
			setState(331);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					setState(328); exclusiveOrExpression(0);
					}
					} 
				}
				setState(333);
	...
	private LogicalAndExpressionContext logicalAndExpression(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(335); inclusiveOrExpression(0);
			}
			_ctx.stop = _input.LT(-1);
			setState(342);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					setState(337);
					if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
					setState(338); match(AndAnd);
					setState(339); inclusiveOrExpression(0);
					}
					} 
				}
				setState(344);
	...
	private LogicalOrExpressionContext logicalOrExpression(int _p) throws RecognitionException {
		...
		try {
			...
			{
			{
			setState(346); logicalAndExpression(0);
			}
			_ctx.stop = _input.LT(-1);
			setState(353);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					setState(348);
					if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
					setState(349); match(OrOr);
					setState(350); logicalAndExpression(0);
					}
					} 
				}
				setState(355);
	...
	public final ConditionalExpressionContext conditionalExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(356); logicalOrExpression(0);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final AssignmentExpressionContext assignmentExpression() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(359); unaryExpression();
				setState(360); assignmentOperator();
		...
		try {
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					setState(372); assignmentExpression();
					}
					} 
				}
				setState(377);
	...
	public final ConstantExpressionContext constantExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(378); conditionalExpression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DeclarationContext declaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(380); declarationSpecifiers();
			setState(382);
			_la = _input.LA(1);
			if (_la==Identifier) {
				{
				setState(381); initDeclaratorList(0);
				}
			}
		...
		try {
			...
			do {
				...
				case 1:
					{
					{
					setState(386); declarationSpecifier();
					}
					}
					break;
				default:
		...
		try {
			...
			do {
				...
				case 1:
					{
					{
					setState(391); declarationSpecifier();
					}
					}
					break;
				default:
	...
	public final DeclarationSpecifierContext declarationSpecifier() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				enterOuterAlt(_localctx, 1);
				{
				setState(396); typeSpecifier();
				}
				break;
			case Const:
				enterOuterAlt(_localctx, 2);
				{
				setState(397); typeQualifier();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final TypeSpecifierContext typeSpecifier() throws RecognitionException {
		...
		try {
			...
			case Struct:
				enterOuterAlt(_localctx, 2);
				{
				setState(419); structSpecifier();
				}
				break;
			case Enum:
				enterOuterAlt(_localctx, 3);
				{
				setState(420); enumSpecifier();
				}
				break;
			case Identifier:
				enterOuterAlt(_localctx, 4);
				{
				setState(421); typedefName();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	private StructDeclarationListContext structDeclarationList(int _p) throws RecognitionException {
		...
		int _startState = 56;
		enterRecursionRule(_localctx, 56, RULE_structDeclarationList, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			{
			setState(425); structDeclaration();
			}
			_ctx.stop = _input.LT(-1);
			setState(431);
			_errHandler.sync(this);
	...
	public final StructDeclarationContext structDeclaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(434); typeSpecifier();
			setState(435); structDeclaratorList(0);
	...
	public final SpecifierQualifierListContext specifierQualifierList() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				enterOuterAlt(_localctx, 1);
				{
				setState(438); typeSpecifier();
				setState(439); specifierQualifierList();
				}
				break;
			case Const:
				enterOuterAlt(_localctx, 2);
				{
				setState(441); typeQualifier();
	...
	public final StructSpecifierContext structSpecifier() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_structSpecifier);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(446); match(Struct);
			setState(447); match(Identifier);
			setState(448); match(LeftBrace);
			setState(449); structDeclarationList(0);
			setState(450); match(RightBrace);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final StructDeclaratorContext structDeclarator() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(468); constantExpression();
				}
				break;
			}
		}
	...
	public final EnumSpecifierContext enumSpecifier() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_enumSpecifier);
		try {
			setState(484);
			...
			case 1:
				...
				setState(473); match(LeftBrace);
				setState(474); enumeratorList(0);
				setState(475); match(RightBrace);
				}
				break;
			...
			case 2:
				...
				setState(479); match(LeftBrace);
				setState(480); enumeratorList(0);
	...
	private EnumeratorListContext enumeratorList(int _p) throws RecognitionException {
		...
		int _startState = 70;
		enterRecursionRule(_localctx, 70, RULE_enumeratorList, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			{
			setState(487); enumerator();
			}
			_ctx.stop = _input.LT(-1);
			setState(494);
			_errHandler.sync(this);
	...
	public final EnumeratorContext enumerator() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(497); enumerationConstant();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DeclaratorContext declarator() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(503); directDeclarator(0);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private DirectDeclaratorContext directDeclarator(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(508); match(LeftBracket);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(514); parameterTypeList();
						setState(515); match(RightParen);
						}
						break;
					...
					case 2:
						...
						setState(517);
						if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
						setState(518); match(LeftParen);
						setState(520);
						_la = _input.LA(1);
						if (_la==Identifier) {
							{
							setState(519); identifierList(0);
							}
						}
	...
	public final BashExtensionContext bashExtension() throws RecognitionException {
		...
		enterRule(_localctx, 82, RULE_bashExtension);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			do {
				{
				{
				setState(530); match(StringLiteral);
				}
				}
				setState(533); 
				_errHandler.sync(this);
	...
	private TypeQualifierListContext typeQualifierList(int _p) throws RecognitionException {
		...
		int _startState = 84;
		enterRecursionRule(_localctx, 84, RULE_typeQualifierList, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ParameterTypeListContext parameterTypeList() throws RecognitionException {
		...
		enterRule(_localctx, 86, RULE_parameterTypeList);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(547); parameterList(0);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private ParameterListContext parameterList(int _p) throws RecognitionException {
		...
		int _startState = 88;
		enterRecursionRule(_localctx, 88, RULE_parameterList, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			{
			setState(550); parameterDeclaration();
			}
			_ctx.stop = _input.LT(-1);
			setState(557);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					setState(554); parameterDeclaration();
					}
					} 
				}
				setState(559);
	...
	public final ParameterDeclarationContext parameterDeclaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(560); declarationSpecifiers();
				setState(561); declarator();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(563); declarationSpecifiers2();
				setState(565);
				switch ( getInterpreter().adaptivePredict(_input,47,_ctx) ) {
				case 1:
					{
					setState(564); directAbstractDeclarator(0);
					}
					break;
				}
				}
	...
	private IdentifierListContext identifierList(int _p) throws RecognitionException {
		...
		int _startState = 92;
		enterRecursionRule(_localctx, 92, RULE_identifierList, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final TypeNameContext typeName() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(580); specifierQualifierList();
			setState(582);
			_la = _input.LA(1);
			if (_la==LeftBracket) {
				{
				setState(581); directAbstractDeclarator(0);
				}
			}
	...
	private DirectAbstractDeclaratorContext directAbstractDeclarator(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(585); match(LeftBracket);
				setState(587);
				_la = _input.LA(1);
				if (_la==Const) {
					{
					setState(586); typeQualifierList(0);
					}
				}
				...
				if (((((_la - 21)) & ~0x3f) == 0 && ((1L << (_la - 21)) & ((1L << (LeftParen - 21)) | (1L << (Plus - 21)) | (1L << (PlusPlus - 21)) | (1L << (Minus - 21)) | (1L << (MinusMinus - 21)) | (1L << (Not - 21)) | (1L << (Identifier - 21)) | (1L << (Constant - 21)) | (1L << (StringLiteral - 21)))) != 0)) {
					{
					setState(589); assignmentExpression();
					}
				}

				setState(592); match(RightBracket);
				}
				break;
			...
			case 2:
				...
				setState(596); assignmentExpression();
				setState(597); match(RightBracket);
				}
				break;
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(604);
						if (!(precpred(_ctx, 2))) throw new FailedPredicateException(this, "precpred(_ctx, 2)");
						setState(605); match(LeftBracket);
						setState(606); match(Star);
						setState(607); match(RightBracket);
						}
						break;
					...
					case 2:
						...
						setState(611);
						_la = _input.LA(1);
						if (((((_la - 5)) & ~0x3f) == 0 && ((1L << (_la - 5)) & ((1L << (Const - 5)) | (1L << (Enum - 5)) | (1L << (Int - 5)) | (1L << (Struct - 5)) | (1L << (Void - 5)) | (1L << (String - 5)) | (1L << (Identifier - 5)))) != 0)) {
							{
							setState(610); parameterList(0);
							}
						}
	...
	public final InitializerContext initializer() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(622); match(LeftBrace);
				setState(623); initializerList(0);
				setState(624); match(RightBrace);
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(626); match(LeftBrace);
				setState(627); initializerList(0);
				setState(628); match(Comma);
				setState(629); match(RightBrace);
				}
				break;
			}
		}
	...
	private InitializerListContext initializerList(int _p) throws RecognitionException {
		...
		int _startState = 102;
		enterRecursionRule(_localctx, 102, RULE_initializerList, _p);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					if (_la==LeftBracket || _la==Dot) {
						{
						setState(641); designation();
						}
					}

					setState(644); initializer();
					}
					} 
				}
				setState(649);
	...
	public final DesignatorContext designator() throws RecognitionException {
		...
		try {
			...
			case LeftBracket:
				enterOuterAlt(_localctx, 1);
				{
				setState(653); match(LeftBracket);
				setState(654); constantExpression();
				setState(655); match(RightBracket);
				}
				break;
			case Dot:
				enterOuterAlt(_localctx, 2);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case Default:
				enterOuterAlt(_localctx, 1);
				{
				setState(661); labeledStatement();
				}
				break;
			case LeftBrace:
				enterOuterAlt(_localctx, 2);
				{
				setState(662); compoundStatement();
				}
				break;
			case LeftParen:
			case Plus:
			...
			case StringLiteral:
				enterOuterAlt(_localctx, 3);
				{
				setState(663); expressionStatement();
				}
				break;
			case If:
			case Switch:
				enterOuterAlt(_localctx, 4);
				{
				setState(664); selectionStatement();
				}
				break;
			case Do:
			case For:
			case While:
				...
				{
				setState(665); iterationStatement();
				}
				break;
			case Break:
			case Continue:
			case Return:
				...
				{
				setState(666); jumpStatement();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 7);
				{
				setState(667); bashExtension();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final LabeledStatementContext labeledStatement() throws RecognitionException {
		...
		try {
			...
			case Case:
				enterOuterAlt(_localctx, 1);
				{
				setState(670); match(Case);
				setState(671); constantExpression();
	...
	public final CompoundStatementContext compoundStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(680); match(LeftBrace);
			setState(682);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 2) | (1L << Break) | (1L << Case) | (1L << Const) | (1L << Continue) | (1L << Default) | (1L << Do) | (1L << Enum) | (1L << For) | (1L << If) | (1L << Int) | (1L << Return) | (1L << Struct) | (1L << Switch) | (1L << Void) | (1L << While) | (1L << String) | (1L << LeftParen) | (1L << LeftBrace) | (1L << Plus) | (1L << PlusPlus) | (1L << Minus) | (1L << MinusMinus) | (1L << Not) | (1L << Semi))) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (Identifier - 67)) | (1L << (Constant - 67)) | (1L << (StringLiteral - 67)))) != 0)) {
				{
				setState(681); blockItemList(0);
				}
			}

			setState(684); match(RightBrace);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private BlockItemListContext blockItemList(int _p) throws RecognitionException {
		...
		int _startState = 114;
		enterRecursionRule(_localctx, 114, RULE_blockItemList, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			{
			setState(687); blockItem();
			}
			_ctx.stop = _input.LT(-1);
			setState(693);
			_errHandler.sync(this);
	...
	public final SelectionStatementContext selectionStatement() throws RecognitionException {
		...
		try {
			...
			case If:
				enterOuterAlt(_localctx, 1);
				{
				setState(705); match(If);
				setState(706); match(LeftParen);
			...
			case Switch:
				enterOuterAlt(_localctx, 2);
				{
				setState(714); match(Switch);
				setState(715); match(LeftParen);
	...
	public final CompilationUnitContext compilationUnit() throws RecognitionException {
		...
		try {
			...
			setState(778);
			_la = _input.LA(1);
			if (((((_la - 5)) & ~0x3f) == 0 && ((1L << (_la - 5)) & ((1L << (Const - 5)) | (1L << (Enum - 5)) | (1L << (Int - 5)) | (1L << (Struct - 5)) | (1L << (Void - 5)) | (1L << (String - 5)) | (1L << (Semi - 5)) | (1L << (Identifier - 5)))) != 0)) {
				{
				setState(777); translationUnit(0);
				}
			}
	...
	private TranslationUnitContext translationUnit(int _p) throws RecognitionException {
		...
		int _startState = 128;
		enterRecursionRule(_localctx, 128, RULE_translationUnit, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			{
			setState(783); externalDeclaration();
			}
			_ctx.stop = _input.LT(-1);
			setState(789);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					setState(785);
					if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
					setState(786); externalDeclaration();
					}
					} 
				}
				setState(791);
	...
	public final ExternalDeclarationContext externalDeclaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(792); functionDefinition();
				}
				break;
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(797); declarationSpecifiers();
				}
				break;
			}
			setState(800); declarator();
			setState(802);
			_la = _input.LA(1);
			if (((((_la - 5)) & ~0x3f) == 0 && ((1L << (_la - 5)) & ((1L << (Const - 5)) | (1L << (Enum - 5)) | (1L << (Int - 5)) | (1L << (Struct - 5)) | (1L << (Void - 5)) | (1L << (String - 5)) | (1L << (Identifier - 5)))) != 0)) {
				{
				setState(801); declarationList(0);
				}
			}

			setState(804); compoundStatement();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private DeclarationListContext declarationList(int _p) throws RecognitionException {
		...
		int _startState = 134;
		enterRecursionRule(_localctx, 134, RULE_declarationList, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			{
			setState(807); declaration();
			}
			_ctx.stop = _input.LT(-1);
			setState(813);
			_errHandler.sync(this);
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		...
		case 28: return structDeclarationList_sempred((StructDeclarationListContext)_localctx, predIndex);

		case 32: return structDeclaratorList_sempred((StructDeclaratorListContext)_localctx, predIndex);

		case 35: return enumeratorList_sempred((EnumeratorListContext)_localctx, predIndex);

		case 40: return directDeclarator_sempred((DirectDeclaratorContext)_localctx, predIndex);

		case 42: return typeQualifierList_sempred((TypeQualifierListContext)_localctx, predIndex);

		case 44: return parameterList_sempred((ParameterListContext)_localctx, predIndex);

		case 46: return identifierList_sempred((IdentifierListContext)_localctx, predIndex);

		case 48: return directAbstractDeclarator_sempred((DirectAbstractDeclaratorContext)_localctx, predIndex);

		case 51: return initializerList_sempred((InitializerListContext)_localctx, predIndex);

		case 57: return blockItemList_sempred((BlockItemListContext)_localctx, predIndex);

		case 64: return translationUnit_sempred((TranslationUnitContext)_localctx, predIndex);

		case 67: return declarationList_sempred((DeclarationListContext)_localctx, predIndex);
		}
		return true;
	}
	...
	public static final String _serializedATN =
		...
		"\7\3\u00bd\n\3\f\3\16\3\u00c0\13\3\3\4\3\4\3\4\3\4\3\4\3\4\7\4\u00c8\n"+
		"\4\f\4\16\4\u00cb\13\4\3\5\3\5\3\5\3\5\3\5\3\5\3\5\3\5\5\5\u00d5\n\5\3"+
		"\6\3\6\3\7\3\7\3\7\3\7\3\7\3\7\5\7\u00df\n\7\3\b\3\b\3\b\3\b\3\b\3\b\3"+
		"\b\3\b\3\b\3\b\3\b\3\b\7\b\u00ed\n\b\f\b\16\b\u00f0\13\b\3\t\3\t\3\t\3"+
		"\t\3\t\3\t\3\t\3\t\3\t\7\t\u00fb\n\t\f\t\16\t\u00fe\13\t\3\n\3\n\3\n\3"+
		"\n\3\n\3\n\3\n\3\n\3\n\7\n\u0109\n\n\f\n\16\n\u010c\13\n\3\13\3\13\3\13"+
		"\3\13\3\13\3\13\3\13\3\13\3\13\3\13\3\13\3\13\3\13\3\13\3\13\7\13\u011d"+
		"\n\13\f\13\16\13\u0120\13\13\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f\7\f\u012b"+
		"\n\f\f\f\16\f\u012e\13\f\3\r\3\r\3\r\3\r\3\r\3\r\7\r\u0136\n\r\f\r\16"+
		"\r\u0139\13\r\3\16\3\16\3\16\3\16\3\16\3\16\7\16\u0141\n\16\f\16\16\16"+
		"\u0144\13\16\3\17\3\17\3\17\3\17\3\17\3\17\7\17\u014c\n\17\f\17\16\17"+
		"\u014f\13\17\3\20\3\20\3\20\3\20\3\20\3\20\7\20\u0157\n\20\f\20\16\20"+
		"\u015a\13\20\3\21\3\21\3\21\3\21\3\21\3\21\7\21\u0162\n\21\f\21\16\21"+
		"\u0165\13\21\3\22\3\22\3\23\3\23\3\23\3\23\3\23\5\23\u016e\n\23\3\24\3"+
		"\24\3\25\3\25\3\25\3\25\3\25\3\25\7\25\u0178\n\25\f\25\16\25\u017b\13"+
		"\25\3\26\3\26\3\27\3\27\5\27\u0181\n\27\3\27\3\27\3\30\6\30\u0186\n\30"+
		"\r\30\16\30\u0187\3\31\6\31\u018b\n\31\r\31\16\31\u018c\3\32\3\32\5\32"+
		"\u0191\n\32\3\33\3\33\3\33\3\33\3\33\3\33\7\33\u0199\n\33\f\33\16\33\u019c"+
		"\13\33\3\34\3\34\3\34\3\34\3\34\5\34\u01a3\n\34\3\35\3\35\3\35\3\35\5"+
		"\35\u01a9\n\35\3\36\3\36\3\36\3\36\3\36\7\36\u01b0\n\36\f\36\16\36\u01b3"+
		"\13\36\3\37\3\37\3\37\3\37\3 \3 \3 \3 \3 \3 \5 \u01bf\n \3!\3!\3!\3!\3"+
		"!\3!\3\"\3\"\3\"\3\"\3\"\3\"\7\"\u01cd\n\"\f\"\16\"\u01d0\13\"\3#\3#\5"+
		...
		"\n/\3\60\3\60\3\60\3\60\3\60\3\60\7\60\u0242\n\60\f\60\16\60\u0245\13"+
		"\60\3\61\3\61\5\61\u0249\n\61\3\62\3\62\3\62\5\62\u024e\n\62\3\62\5\62"+
		"\u0251\n\62\3\62\3\62\3\62\3\62\3\62\3\62\3\62\3\62\3\62\3\62